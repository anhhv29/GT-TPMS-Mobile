...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageViewScanQR.setOnClickListener(v -> startActivity(new Intent(LoginActivity.this, ScanQrCodeActivity.class)));
    ...
    private void warning() {
        ...
        handler.postDelayed(() -> lnWarning.setVisibility(View.INVISIBLE), 2000);
    }
